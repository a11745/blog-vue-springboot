<template>
  <el-card>
    <h1 class="me-author-name">jokerq</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;哈尔滨&北京</span>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '651794863'},
        github: {
          title: 'github',
          message: '<a target="_blank" href="https://github.com/a11745">https://github.com/a11745</a>'
        }
      }
    },
    methods: {
